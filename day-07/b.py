class Hand:
    ...
    cards_values_order = ["A", "K", "Q", "T", "9", "8", "7", "6", "5", "4", "3", "2", "J"]
    ...
    def type_setter(self):
        ...
        if temp.count(temp[0]) == 5 or temp.count(temp[0])+temp.count("J") == 5:
            return "five of a kind"
        
        elif temp.count(temp[1]) == 4 or temp.count(temp[1])+temp.count("J") == 4:
        ...
        elif temp.count("J") == 1 and (temp.count(temp[0]) == 2 or temp.count(temp[2]) == 2):
        ...
        elif temp.count(temp[1])+temp.count("J") == 2 or temp.count(temp[3])+temp.count("J") == 2:
            return "pair"
